...
function seedDefaultExercises(db) {
  ...
  const exercises = [
    ...
    { category: 'breathing', title_ru: 'Дыхание 4-7-8', title_en: '4-7-8 Breathing', title_es: 'Respiracion 4-7-8', title_uk: 'Дихання 4-7-8',
      description_ru: 'Техника дыхания для быстрого засыпания и успокоения', description_en: 'Breathing pattern for quick relaxation and sleep aid', description_es: 'Patron de respiracion para relajacion rapida', description_uk: 'Техніка дихання для швидкого засинання та заспокоєння',
    ...
    { category: 'cognitive', title_ru: 'Рефрейминг', title_en: 'Cognitive Reframing', title_es: 'Reestructuracion cognitiva', title_uk: 'Рефреймінг',
      description_ru: 'Техника изменения перспективы на негативные события', description_en: 'Technique to change perspective on negative events and find alternative viewpoints', description_es: 'Tecnica para cambiar la perspectiva sobre eventos negativos', description_uk: 'Техніка зміни перспективи на негативні події',
    ...
    { category: 'cognitive', title_ru: 'Анализ доказательств', title_en: 'Evidence Examination', title_es: 'Examen de evidencia', title_uk: 'Аналіз доказів',
      description_ru: 'Проверка негативных убеждений через сбор доказательств', description_en: 'Examine evidence for and against negative beliefs to develop balanced thinking', description_es: 'Examinar evidencia a favor y en contra de creencias negativas', description_uk: 'Перевірка негативних переконань через збір доказів',
