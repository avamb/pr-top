...
🔒 Encryption · GDPR · Your data belongs only to you`,
    ...
    consentDisclaimerHeader: (name, version) => `🔐 *Consent disclaimer (v${version}) — ${name}*\n\nBefore connecting, please review and agree to *all five* points below. You cannot skip this step — your therapist relies on your informed consent to work with you between sessions.`,
    ...
    consentDisclaimerFooter: 'Tick *each* of the five boxes below, then press *I agree and connect*.',
    ...
    consentNotAllChecked: '⚠️ Please tick all 5 boxes before continuing.',
...
🔒 Шифрование · GDPR · Данные только ваши`,
    ...
    // T-18 Extended consent disclaimer (multi-checkbox flow)
    consentDisclaimerHeader: (name, version) => `🔐 *Информированное согласие (v${version}) — ${name}*\n\nПрежде чем подключиться, пожалуйста, ознакомьтесь и согласитесь со *всеми пятью* пунктами ниже. Этот шаг нельзя пропустить — ваш терапевт работает с вами между сессиями только при наличии вашего информированного согласия.`,
    ...
    consentDisclaimerFooter: 'Отметьте *каждый* из пяти пунктов ниже, затем нажмите *Согласен и подключиться*.',
    ...
    consentNotAllChecked: '⚠️ Пожалуйста, отметьте все 5 пунктов перед продолжением.',
...
🔒 Cifrado · RGPD · Tus datos te pertenecen solo a ti`,
    ...
    // T-18 Extended consent disclaimer (multi-checkbox flow)
    consentDisclaimerHeader: (name, version) => `🔐 *Consentimiento informado (v${version}) — ${name}*\n\nAntes de conectarte, por favor lee y acepta *los cinco* puntos siguientes. No puedes saltarte este paso — tu terapeuta confía en tu consentimiento informado para trabajar contigo entre sesiones.`,
    ...
    consentDisclaimerFooter: 'Marca *cada* una de las cinco casillas y pulsa *Acepto y conectar*.',
    ...
    consentNotAllChecked: '⚠️ Por favor marca las 5 casillas antes de continuar.',
...
🔒 Шифрування · GDPR · Дані тільки ваші`,
    ...
    // T-18 Extended consent disclaimer (multi-checkbox flow)
    consentDisclaimerHeader: (name, version) => `🔐 *Інформована згода (v${version}) — ${name}*\n\nПеред підключенням, будь ласка, ознайомтеся та погодьтеся з *усіма п'ятьма* пунктами нижче. Цей крок неможливо пропустити — ваш терапевт працює з вами між сесіями лише за вашою інформованою згодою.`,
    ...
    consentDisclaimerFooter: 'Позначте *кожен* із п\'яти пунктів нижче та натисніть *Згоден і підключитися*.',
    ...
    consentNotAllChecked: '⚠️ Будь ласка, позначте всі 5 пунктів перед продовженням.',
