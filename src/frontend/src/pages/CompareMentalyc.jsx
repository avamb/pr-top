...
const CONTENT = {
  ...
  uk: {
    ...
    seoDescription:
      'Mentalyc — американський AI-інструмент для нотаток сесій. PR-TOP додає роботу між сесіями: щоденник у Telegram, вправи, SOS. Хостинг у ЄС, GDPR за замовчуванням.',
