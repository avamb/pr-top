  ...
  return (
    <SecurityPageLayout titleKey="security.dataSovereigntyTitle">
      <Seo
        ...
        description="PR-TOP stores all client data in the EU. Therapists control who has access — consent is checked on every request, and full data deletion is available at any time."
      />
      <Section
