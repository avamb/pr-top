...
const CONTENT = {
  ...
  ru: {
    ...
    seoDescription:
      'PR-TOP: зашифрованное управление практикой в ЕС — дневник клиента, упражнения, SOS и заметки сессий. AES-шифрование, GDPR-first, аудит-лог.',
  ...
  uk: {
    ...
    seoDescription:
      'PR-TOP: зашифроване управління практикою у ЄС — щоденник клієнта, вправи, SOS та нотатки сесій. AES-шифрування, GDPR-first, журнал аудиту.',
