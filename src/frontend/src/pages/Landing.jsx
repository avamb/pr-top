  ...
  const tiers = [
    {
      ...
      highlight: false,
      features: [
        t('landing.tierFeat.clients3'),
        t('landing.tierFeat.sessions5'),
        t('landing.tierFeat.transcription'),
        t('landing.tierFeat.exercisesBasic'),
        t('landing.tierFeat.agreedProtocol'),
        t('landing.tierFeat.timeline'),
        t('landing.tierFeat.dashboardBasic'),
      ],
    },
    {
      name: 'Basic',
      ...
      highlight: false,
      features: [
        t('landing.tierFeat.clients10'),
        t('landing.tierFeat.sessions20'),
        t('landing.tierFeat.transcription'),
        t('landing.tierFeat.exercisesFull'),
        t('landing.tierFeat.agreedProtocol'),
        t('landing.tierFeat.timeline'),
        t('landing.tierFeat.dashboardBasic'),
      ],
    },
    {
      ...
      highlight: true,
      features: [
        t('landing.tierFeat.clients30'),
        t('landing.tierFeat.sessions60'),
        t('landing.tierFeat.transcription'),
        t('landing.tierFeat.exercisesCustom'),
        t('landing.tierFeat.nlQuery'),
        t('landing.tierFeat.agreedProtocol'),
        t('landing.tierFeat.dashboardFull'),
      ],
    },
    {
      name: 'Premium',
      ...
      highlight: false,
      features: [
        t('landing.tierFeat.clientsUnlimited'),
        t('landing.tierFeat.sessionsUnlimited'),
        t('landing.tierFeat.transcription'),
        t('landing.tierFeat.exercisesCustom'),
        t('landing.tierFeat.nlQuery'),
        t('landing.tierFeat.prioritySupport'),
        t('landing.tierFeat.analyticsExport'),
      ],
    },
  ];
      ...
      <footer className="bg-text text-white/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            {/* Compare — localized pages, links stay in the active locale */}
            <div>
              <h4 className="text-white font-semibold text-sm mb-3">{t('landing.footerCompare')}</h4>
              <ul className="space-y-2 text-sm">
                <li><Link to={lp('/best-ai-assistant-for-therapists')} className="hover:text-white transition-colors">{t('landing.bestAiAssistants')}</Link></li>
                <li><Link to={lp('/compare/upheal')} className="hover:text-white transition-colors">{t('landing.compareUpheal')}</Link></li>
