...
This command **requires** the project directory as an argument via `C:\Projects\dev-psy-bot`.

**Example:** `/create-spec generations/my-app`

**Output location:** `C:\Projects\dev-psy-bot/.autoforge/prompts/app_spec.txt` and `C:\Projects\dev-psy-bot/.autoforge/prompts/initializer_prompt.md`

If `C:\Projects\dev-psy-bot` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `C:\Projects\dev-psy-bot/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `C:\Projects\dev-psy-bot/.autoforge/prompts/app_spec.txt`
...
**Output path:** `C:\Projects\dev-psy-bot/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `C:\Projects\dev-psy-bot/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `C:\Projects\dev-psy-bot/.autoforge/prompts/`!
>
> **Files created:**
> - `C:\Projects\dev-psy-bot/.autoforge/prompts/app_spec.txt`
> - `C:\Projects\dev-psy-bot/.autoforge/prompts/initializer_prompt.md`
>
